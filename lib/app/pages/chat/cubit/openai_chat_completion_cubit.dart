...
class OpenAiChatCompletionCubit extends HydratedCubit<OpenAiChatCompletionState> {
  final OpenAiService openAiService;

  OpenAiChatCompletionCubit._(
    List<Chat> chats,
    Chat chat,
    this.openAiService,
  ) : super(ChatCompletionInitial(chats, chat));

  factory OpenAiChatCompletionCubit() {
    final chat = Chat.initial();
    OpenAiService openAiService = OpenAiService();
    return OpenAiChatCompletionCubit._(
      [chat],
      chat,
      openAiService,
    );
